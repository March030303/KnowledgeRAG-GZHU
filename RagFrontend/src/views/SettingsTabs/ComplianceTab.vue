        ...
        <div class="masking-scope">
          ...
          <div class="scope-checks">
            <label class="check-item"
              ><input type="checkbox" v-model="maskingScope.rag_output" />RAG 输出</label
            >
            <label class="check-item"
              ><input type="checkbox" v-model="maskingScope.audit_logs" />审计日志</label
            >
            <label class="check-item"
              ><input type="checkbox" v-model="maskingScope.export" />数据导出</label
            >
            <label class="check-item"
              ><input type="checkbox" v-model="maskingScope.api_response" />API 响应</label
            >
          </div>
        </div>
...
示例：联系我：13812345678，邮箱：test@example.com，身份证：440101199001011234"
        ></textarea>
        <button class="btn-primary-sm" @click="testMasking" style="margin-top: 8px">
          运行脱敏
        </button>
