          ...
          <div v-if="activeNote" class="note-editor">
            ...
            <div class="note-toolbar">
              ...
              <div class="note-toolbar-right">
                <button class="note-tool-btn" @click="insertMarkdown('**', '**')" title="粗体">
                  B
                </button>
                <button
                ...
                <button class="note-tool-btn" @click="insertMarkdown('`', '`')" title="代码">
                  &lt;&gt;
                </button>
                <button class="note-tool-btn" @click="insertMarkdown('- ', '')" title="列表">
                  ≡
                </button>
                <button
                  class="note-save-btn"
